...
class TestProgram(unittest.TestCase):
    ...
    def test_case_7(self):
        test = BinaryTree(1).insert(
            [-10, -5, 30, 75, -20, -21, 5, 1, 3, -3, 100, 2, 100, 1,
             100])
        self.assertEqual(program.maxPathSum(test), 203)

    def test_case_8(self):
        test = BinaryTree(1).insert(
            [-150, -5, 30, 75, -20, -21, 5, 1, 3, -3, 100, 2, 100, 1,
             100, 100, 5, 10, 150, -8])
    ...
    def test_case_9(self):
        test = BinaryTree(1).insert(
            [-150, -5, 30, 75, -20, -21, 5, 1, 3, -3, 100, 2, 100, 1,
             100, 100, 5, 10, 150, 151]
        )
        self.assertEqual(program.maxPathSum(test), 304)

    def test_case_10(self):
        test = BinaryTree(1).insert(
            [-5, -3, 0, 2, 2, 1, -3, 3, 1, 1, 0, 5, 1, 1, 0, 1, 1, -1,
             -1, -6, -1, -100, -9, -91, 2, 1, 0, 1, -5, 0]
        )
        self.assertEqual(program.maxPathSum(test), 9)

    def test_case_11(self):
        test = BinaryTree(1).insert(
            [-5, -3, 0, 2, 2, 1, -3, -4, 1, 1, 0, 5, 1, 1, 0, 1, 10, -1,
             -1, -6, -1, -100, -9, -91, 2, 1, 0, 1, -5, 0]
        )
