...
# sort the array.
#
# If you're unfamiliar with Insertion Sort, we recommend watching the
...
# Hints
# Hint 1
# Divide the input array into two subarrays in place. The first subarray
# should be sorted at all times and should start with a length of 1,
# while the second subarray should be unsorted. Iterate through the
# unsorted subarray, inserting all of its elements into the sorted
...
# input array
# Worst: O(n^2) time | O(1) space - where n is the length of the
# input array
