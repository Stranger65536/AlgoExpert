...
test5.addChild("B").addChild("C").addChild("D").addChild("L").addChild(
    "M")
...
class TestProgram(unittest.TestCase):
    def test_case_1(self):
        self.assertEqual(test1.depthFirstSearch([]),
                         ["A", "B", "D", "C"])

    def test_case_2(self):
        self.assertEqual(test2.depthFirstSearch([]),
                         ["A", "B", "C", "F", "D", "E"])

    def test_case_3(self):
        self.assertEqual(test3.depthFirstSearch([]),
                         ["A", "B", "C", "D", "F", "E"])

    def test_case_4(self):
        self.assertEqual(test4.depthFirstSearch([]),
                         ["A", "B", "E", "F", "I", "J", "C", "D", "G",
                          "K", "H"])
