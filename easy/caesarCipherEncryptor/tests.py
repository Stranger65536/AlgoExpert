...
class TestProgram(unittest.TestCase):
    ...
    def test_case_5(self):
        self.assertEqual(program.caesarCipherEncryptor("abc", 26),
                         "abc")

    def test_case_6(self):
        self.assertEqual(program.caesarCipherEncryptor("abc", 52),
                         "abc")

    def test_case_7(self):
        self.assertEqual(program.caesarCipherEncryptor("abc", 57),
                         "fgh")
