...
class TestProgram(unittest.TestCase):
    def test_case_1(self):
        ...
        self.assertEqual(test1.getNodesInArray(),
                         result1.getNodesInArray())
    ...
    def test_case_2(self):
        ...
        self.assertEqual(test2.getNodesInArray(),
                         result2.getNodesInArray())
    ...
    def test_case_3(self):
        ...
        self.assertEqual(test3.getNodesInArray(),
                         result3.getNodesInArray())
    ...
    def test_case_4(self):
        ...
        self.assertEqual(test4.getNodesInArray(),
                         result4.getNodesInArray())
    ...
    def test_case_5(self):
        ...
        self.assertEqual(test5.getNodesInArray(),
                         result5.getNodesInArray())
    ...
    def test_case_6(self):
        ...
        self.assertEqual(test6.getNodesInArray(),
                         result6.getNodesInArray())
    ...
    def test_case_7(self):
        ...
        self.assertEqual(test7.getNodesInArray(),
                         result7.getNodesInArray())
    ...
    def test_case_8(self):
        ...
        self.assertEqual(test8.getNodesInArray(),
                         result8.getNodesInArray())
    ...
    def test_case_9(self):
        ...
        self.assertEqual(test9.getNodesInArray(),
                         result9.getNodesInArray())
    ...
    def test_case_10(self):
        ...
        self.assertEqual(test10.getNodesInArray(),
