...
#
# If you're unfamiliar with tree-traversal techniques, we recommend
# watching the Conceptual Overview section of this question's video
...
# array = []
# Sample Output
# inOrderTraverse: [1, 2, 5, 5, 10, 15, 22] // where the array is the
# input array
# preOrderTraverse: [10, 5, 2, 1, 5, 15, 22] // where the array is the
# input array
...
# implementing this algorithm recursively by calling the inOrderTraverse
# method on a left node, then appending the current node's value to the
# input array, and then calling the inOrderTraverse method on a right
# node.
#
# Hint 2
...
# All three methods: O(n) time | O(n) space - where n is the number
# of nodes in the BST
