...
# respectively. Move the right pointer inwards so long as it points to
# the integer to move, and move the left pointer inwards so long as it
# doesn't point to the integer to move. When both pointers aren't
# moving, swap their values in place. Repeat this process until the
