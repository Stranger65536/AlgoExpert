...
class TestProgram(unittest.TestCase):
    ...
    def test_case_6(self):
        self.assertEqual(
            program.maxSubsetSumNoAdjacent([7, 10, 12, 7, 9, 14]), 33)

    def test_case_7(self):
        self.assertEqual(
            program.maxSubsetSumNoAdjacent([4, 3, 5, 200, 5, 3]), 207)
    ...
    def test_case_11(self):
        self.assertEqual(
            program.maxSubsetSumNoAdjacent([30, 25, 50, 55, 100]), 180)

    def test_case_12(self):
        self.assertEqual(
            program.maxSubsetSumNoAdjacent([30, 25, 50, 55, 100, 120]),
            205)
