    ...
    def test_case_1(self):
        ...
        for currentIdx in range(len(test1.heap)):
            ...
            if parentIdx < 0:
                break
            self.assertEqual(
                test1.heap[currentIdx] >= test1.heap[parentIdx], True)
    ...
    def test_case_2(self):
        ...
        for currentIdx in range(len(test2.heap)):
            ...
            if parentIdx < 0:
                break
            self.assertEqual(
                test2.heap[currentIdx] >= test2.heap[parentIdx], True)
    ...
    def test_case_3(self):
        ...
        for currentIdx in range(len(test3.heap)):
            ...
            if parentIdx < 0:
                break
            self.assertEqual(
                test3.heap[currentIdx] >= test3.heap[parentIdx], True)
    ...
    def test_case_4(self):
        ...
        for currentIdx in range(len(test4.heap)):
            ...
            if parentIdx < 0:
                break
            self.assertEqual(
                test4.heap[currentIdx] >= test4.heap[parentIdx], True)
    ...
    def test_case_5(self):
        ...
        for currentIdx in range(len(test5.heap)):
            ...
            if parentIdx < 0:
                break
            self.assertEqual(
                test5.heap[currentIdx] >= test5.heap[parentIdx], True)
    ...
    def test_case_6(self):
        ...
        for currentIdx in range(len(test6.heap)):
            ...
            if parentIdx < 0:
                break
            self.assertEqual(
                test6.heap[currentIdx] >= test6.heap[parentIdx], True)
    ...
    def test_case_7(self):
        ...
        for currentIdx in range(len(test7.heap)):
            ...
            if parentIdx < 0:
                break
            self.assertEqual(
                test7.heap[currentIdx] >= test7.heap[parentIdx], True)
    ...
    def test_case_8(self):
        ...
        for currentIdx in range(len(test8.heap)):
            ...
            if parentIdx < 0:
                break
            self.assertEqual(
                test8.heap[currentIdx] >= test8.heap[parentIdx], True)
    ...
    def test_case_9(self):
        ...
        for currentIdx in range(len(test9.heap)):
            ...
            if parentIdx < 0:
                break
            self.assertEqual(
                test9.heap[currentIdx] >= test9.heap[parentIdx], True)
