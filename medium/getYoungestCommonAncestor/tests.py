...
ancestralTrees["A"].addAsAncestor(
    [ancestralTrees["B"], ancestralTrees["C"], ancestralTrees["D"],
     ancestralTrees["E"], ancestralTrees["F"]]
)
...
ancestralTrees["D"].addAsAncestor(
    [ancestralTrees["K"], ancestralTrees["L"]])
ancestralTrees["F"].addAsAncestor(
    [ancestralTrees["M"], ancestralTrees["N"]])
ancestralTrees["H"].addAsAncestor(
    [ancestralTrees["O"], ancestralTrees["P"], ancestralTrees["Q"],
     ancestralTrees["R"]])
ancestralTrees["K"].addAsAncestor([ancestralTrees["S"]])
ancestralTrees["P"].addAsAncestor(
    [ancestralTrees["T"], ancestralTrees["U"]])
...
class TestProgram(unittest.TestCase):
    def test_case_1(self):
        yca = program.getYoungestCommonAncestor(ancestralTrees["A"],
                                                ancestralTrees["A"],
                                                ancestralTrees["B"])
