...
class TestProgram(unittest.TestCase):
    ...
    def test_case_7(self):
        self.assertEqual(
            program.levenshteinDistance("algoexpert", "algozexpert"), 1)

    def test_case_8(self):
        self.assertEqual(
            program.levenshteinDistance("abcdefghij", "1234567890"), 10)

    def test_case_9(self):
        self.assertEqual(
            program.levenshteinDistance("abcdefghij", "a234567890"), 9)

    def test_case_10(self):
        self.assertEqual(
            program.levenshteinDistance("biting", "mitten"), 4)

    def test_case_11(self):
        self.assertEqual(
            program.levenshteinDistance("cereal", "saturday"), 6)

    def test_case_12(self):
        self.assertEqual(
            program.levenshteinDistance("cereal", "saturdzz"), 7)

    def test_case_13(self):
        self.assertEqual(
            program.levenshteinDistance("abbbbbbbbb", "bbbbbbbbba"), 2)
