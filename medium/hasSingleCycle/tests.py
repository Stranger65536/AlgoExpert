...
class TestProgram(unittest.TestCase):
    ...
    def test_case_8(self):
        self.assertEqual(program.hasSingleCycle(
    ...
    def test_case_10(self):
        self.assertEqual(
            program.hasSingleCycle([1, 2, 3, 4, -2, 3, 7, 8, 1]), True)

    def test_case_11(self):
        self.assertEqual(
            program.hasSingleCycle([1, 2, 3, 4, -2, 3, 7, 8, -8]), True)

    def test_case_12(self):
        self.assertEqual(
            program.hasSingleCycle([1, 2, 3, 4, -2, 3, 7, 8, -26]),
            True)
    ...
    def test_case_15(self):
        self.assertEqual(program.hasSingleCycle([2, 3, 1, -4, -4, 2]),
                         True)
